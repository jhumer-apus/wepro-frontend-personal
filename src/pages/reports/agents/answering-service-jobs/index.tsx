...
interface AgentAnsweringServiceJobStats {
  id: number;
  agent: string;
  technician: string;
...
const mockAnsweringServiceStats: AgentAnsweringServiceJobStats[] = [
  { id: 1, agent: "John Carter", technician: "Robert Miles", sourceProvider: "AS Center 1", jobType: "Repair", area: "120 Main St", city: "Dallas", zip: "75201", state: "TX", reportDate: "2026-02-21", jobIncomingCall: 34, jobOutgoingCall: 17, leadIncomingCall: 22, leadOutgoingCall: 9, answeredBookingPct: "62.5%" },
  { id: 2, agent: "Anna Blake", technician: "Sarah Young", sourceProvider: "AS Center 2", jobType: "Installation", area: "300 Oak Ave", city: "Austin", zip: "73301", state: "TX", reportDate: "2026-02-24", jobIncomingCall: 29, jobOutgoingCall: 20, leadIncomingCall: 14, leadOutgoingCall: 11, answeredBookingPct: "70.2%" },
  { id: 3, agent: "Michael Scott", technician: "Nina Brooks", sourceProvider: "AS Center 3", jobType: "Maintenance", area: "88 River Rd", city: "Houston", zip: "77002", state: "TX", reportDate: "2026-02-23", jobIncomingCall: 38, jobOutgoingCall: 12, leadIncomingCall: 30, leadOutgoingCall: 6, answeredBookingPct: "66.1%" },
  { id: 4, agent: "Rachel Green", technician: "Robert Miles", sourceProvider: "AS Center 1", jobType: "Emergency", area: "15 Pine St", city: "Phoenix", zip: "85001", state: "AZ", reportDate: "2026-02-22", jobIncomingCall: 21, jobOutgoingCall: 19, leadIncomingCall: 14, leadOutgoingCall: 8, answeredBookingPct: "58.0%" },
  { id: 5, agent: "David Harper", technician: "Clara West", sourceProvider: "AS Center 4", jobType: "Inspection", area: "444 Lake View", city: "San Diego", zip: "92101", state: "CA", reportDate: "2026-02-20", jobIncomingCall: 41, jobOutgoingCall: 25, leadIncomingCall: 33, leadOutgoingCall: 8, answeredBookingPct: "74.4%" },
  { id: 6, agent: "Sophia Turner", technician: "Sarah Young", sourceProvider: "AS Center 2", jobType: "Repair", area: "760 Sunset Blvd", city: "Los Angeles", zip: "90001", state: "CA", reportDate: "2026-02-19", jobIncomingCall: 18, jobOutgoingCall: 11, leadIncomingCall: 11, leadOutgoingCall: 5, answeredBookingPct: "52.3%" },
  { id: 7, agent: "James Wilson", technician: "Nina Brooks", sourceProvider: "AS Center 3", jobType: "Installation", area: "51 Market St", city: "San Jose", zip: "95112", state: "CA", reportDate: "2026-02-18", jobIncomingCall: 32, jobOutgoingCall: 16, leadIncomingCall: 26, leadOutgoingCall: 5, answeredBookingPct: "68.9%" },
  { id: 8, agent: "Olivia Martin", technician: "Clara West", sourceProvider: "AS Center 4", jobType: "Maintenance", area: "99 Cedar Ln", city: "Miami", zip: "33101", state: "FL", reportDate: "2026-02-17", jobIncomingCall: 25, jobOutgoingCall: 21, leadIncomingCall: 21, leadOutgoingCall: 8, answeredBookingPct: "63.7%" },
  { id: 9, agent: "Daniel Lewis", technician: "Robert Miles", sourceProvider: "AS Center 1", jobType: "Emergency", area: "10 Bay St", city: "Orlando", zip: "32801", state: "FL", reportDate: "2026-02-16", jobIncomingCall: 36, jobOutgoingCall: 14, leadIncomingCall: 27, leadOutgoingCall: 12, answeredBookingPct: "71.0%" },
  { id: 10, agent: "Emma Johnson", technician: "Sarah Young", sourceProvider: "AS Center 3", jobType: "Inspection", area: "620 North Ave", city: "Atlanta", zip: "30301", state: "GA", reportDate: "2026-02-15", jobIncomingCall: 24, jobOutgoingCall: 16, leadIncomingCall: 16, leadOutgoingCall: 6, answeredBookingPct: "59.3%" },
  { id: 11, agent: "Chris Evans", technician: "Nina Brooks", sourceProvider: "AS Center 4", jobType: "Repair", area: "805 Elm St", city: "Chicago", zip: "60601", state: "IL", reportDate: "2026-02-14", jobIncomingCall: 31, jobOutgoingCall: 14, leadIncomingCall: 21, leadOutgoingCall: 5, answeredBookingPct: "67.8%" },
  { id: 12, agent: "Liam Carter", technician: "Clara West", sourceProvider: "AS Center 2", jobType: "Installation", area: "40 State St", city: "Boston", zip: "02108", state: "MA", reportDate: "2026-02-13", jobIncomingCall: 19, jobOutgoingCall: 9, leadIncomingCall: 14, leadOutgoingCall: 6, answeredBookingPct: "54.5%" },
];

export default function AgentsAnsweringServiceJobsReportPage() {
  ...
  const agentOptions = Array.from(new Set(mockAnsweringServiceStats.map(row => row.agent))).map(
    agent => ({ label: agent, value: agent })
  );
  const technicianOptions = Array.from(
    new Set(mockAnsweringServiceStats.map(row => row.technician))
  ).map(technician => ({ label: technician, value: technician }));
  const sourceProviderOptions = Array.from(
    new Set(mockAnsweringServiceStats.map(row => row.sourceProvider))
  ).map(sourceProvider => ({ label: sourceProvider, value: sourceProvider }));
  const jobTypeOptions = Array.from(
    new Set(mockAnsweringServiceStats.map(row => row.jobType))
  ).map(jobType => ({ label: jobType, value: jobType }));

  const filteredRows = useMemo(() => {
    return mockAnsweringServiceStats.filter(row => {
      const matchesSearch =
        searchQuery === "" ||
  ...
  const tableColumns = [
    ...
    {
      columnName: "Answered Booking(%)",
      cell: "answeredBookingPct",
      sortKey: "answeredBookingPct",
    },
  ...
  return (
    <>
      <Head>
        <title>Agent Answering Service Jobs Report - WePro</title>
        <meta name="description" content="Agent answering service jobs report" />
      </Head>
