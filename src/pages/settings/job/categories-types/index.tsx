      ...
      <div key={item._id} className="space-y-1">
        <div
          className={`
            ...
            ${depth === 0 ? 'bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 shadow-sm' : 'bg-gray-50 dark:bg-neutral-800/50 border-gray-100 dark:border-neutral-700'}
            hover:shadow-md hover:border-gray-300 dark:hover:border-neutral-600 hover:bg-${depth === 0 ? 'gray-50 dark:hover:bg-neutral-700' : 'white dark:hover:bg-neutral-700'}
          `}
          style={{
        ...
        >
          ...
          {canExpand && (
            <button
              ...
              className={`
                absolute p-2 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-full transition-all duration-200
                ${isExpanded ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300'}
              `}
          ...
          <div className="flex items-center gap-2 ml-4">
            {(checkPermission('MOD014', 'create') ||
              ...
              <Button
                size="sm"
                variant="outline"
                className="flex items-center gap-2 bg-white dark:bg-neutral-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 border-blue-200 dark:border-blue-800/30 text-blue-700 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-200 transition-colors"
                onClick={() => {
            ...
            {((checkPermission('MOD014', 'edit') && item.isP1) ||
              ...
              <Button
                size="sm"
                variant="ghost"
                className="p-2 hover:bg-gray-100 dark:hover:bg-neutral-700 transition-colors"
              ...
              <>
                {(!item.children || item.children.length === 0) && (
                  <Button
                    size="sm"
                    variant="ghost"
                    className="p-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
        ...
        {isExpanded && hasChildren && (
          <div className="relative">
            ...
            <div
              className="absolute left-0 top-0 bottom-0 w-px bg-gradient-to-b from-blue-300 dark:from-blue-600 to-gray-200 dark:to-neutral-700"
    ...
    return (
      <div className="p-6 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading job categories...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400 mb-4 max-w-md mx-auto">
          ...
          <Button onClick={fetchJobTypesTree} variant="outline" className="dark:border-neutral-700 dark:hover:bg-neutral-800">
            Try Again
          </Button>
        </div>
      </div>
  ...
  return (
    <>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4">
                  <div className="flex justify-between items-end">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-blue-600 dark:text-blue-400 text-sm">Job Types</div>
                    </div>
                  </div>
                </div>
                ...
                {Object.values(data.message.industries).map(industry => (
                  <div key={industry.industry.code} className="space-y-4">
                    {/* Industry Header */}
                    <div className="border-b-2 border-gray-200 dark:border-neutral-700 pb-4">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mt-2 ml-6">
                        Industry Code:{' '}
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-md dark:bg-neutral-900 dark:border-neutral-800">
          ...
          <form
            ...
            onInvalid={() => setJobSubmitted(true)}
            className="space-y-4"
            data-submitted={jobSubmitted}
          >
            {/* Industry Display */}
            <div className="space-y-2">
              <Label className="dark:text-gray-300">Industry</Label>
              <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-md">
                <div className="w-3 h-3 bg-blue-500 dark:bg-blue-400 rounded-full"></div>
            ...
            {isSubType && selectedParent && (
              <div className="space-y-2">
                <Label className="dark:text-gray-300">Parent Job Type</Label>
                <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-md">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className={
                  jobSubmitted && !formData.name
                    ? 'h-10 border-red-500 focus:border-red-500 !focus-visible:ring-red-500'
                    : 'h-10'
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className={`flex min-h-[60px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${
                  jobSubmitted && !formData.description.trim()
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 dark:border-neutral-600 text-blue-600 dark:text-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400 dark:bg-neutral-800"
              />
              <Label
                htmlFor="car_info"
            ...
            {/* Active Status */}
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-800 rounded-lg border dark:border-neutral-700">
      ...
      <Dialog open={industryModalOpen} onOpenChange={setIndustryModalOpen}>
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto dark:bg-neutral-900 dark:border-neutral-800">
          ...
          <form
            ...
            onInvalid={() => setIndustrySubmitted(true)}
            className="space-y-6"
            data-submitted={industrySubmitted}
          >
            <div className="space-y-3">
              <Label
              ...
              <Input
                ...
                required
                className={
                  industrySubmitted && !industryFormData.name
            ...
            <DialogFooter className="pt-6 border-t border-neutral-200 dark:border-neutral-700">
              <Button
                ...
                className="h-11 px-6 dark:border-neutral-700 dark:hover:bg-neutral-800"
              >
                Cancel
              </Button>
              <Button
