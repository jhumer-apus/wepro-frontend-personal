...
export default function CreateJobTemplatePage(): React.JSX.Element {
  ...
  const handleInputChange = (
    field: keyof JobTemplateFormData,
  ...
  const handleChannelChange = (
    channel: keyof JobTemplateFormData['channels'],
    field: string,
    value: any
  ) => {
    setFormData(prev => ({
  ...
  if (!checkPermission('MOD037', isEditMode ? 'edit' : 'create')) {
    return (
  ...
  return (
    <>
      <Head>
        <title>
          {isEditMode ? 'Edit Job Template' : 'Create Job Template'} - WePro
        </title>
        <meta
          name="description"
          content={
            isEditMode
              ? 'Edit existing job template'
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <button
            onClick={() => router.push('/settings/templates/jobs')}
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">
                {isEditMode ? 'Edit Job Template' : 'Create New Job Template'}
              </h1>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="title"
                    type="text"
                    placeholder="Enter job template title"
              ...
              {formData.channels.email.enabled && (
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="subject"
                      placeholder="Job #{{jobNumber}} Scheduled"
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">
                      Use variables like {'{{jobNumber}}'}, {'{{customerName}}'}
                      , {'{{scheduledDate}}'}, {'{{scheduledTime}}'},{' '}
                      {'{{assignedTo}}'}, {'{{companyName}}'}, and{' '}
                      {'{{jobLink}}'} that will be replaced dynamically.
                    </p>
                  </div>
              ...
              {formData.channels.sms.enabled && (
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="smsTemplate"
                      placeholder="Enter SMS content. Use variables like {{jobNumber}}, {{customerName}}, etc."
              ...
              {formData.channels.whatsapp.enabled && (
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="whatsappTemplate"
                      placeholder="Enter WhatsApp content. Use variables like {{jobNumber}}, {{customerName}}, etc."
