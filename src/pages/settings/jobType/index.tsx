...
export default function JobTypePage() {
  ...
  const TABS = [
    ...(getUserType() !== 'P1' && checkPermission('MOD008', 'view')
      ? [
          {
            key: 'companyProfile',
            label: 'Company Profile',
  ...
  const handleEditIndustry = (industry: Industry) => {
    router.push(`/settings/jobType/create?id=${industry._id}`)
  }
  ...
  return (
    <>
      <Head>
        <title>Job Type - Settings - WePro</title>
        <meta
          name="description"
          ...
          <>
            {(getUserType() === 'P1' ||
              ...
              <div className="flex space-x-1 bg-gray-100 rounded-lg p-1">
                {TABS.map(tab => {
                  const Icon = tab.icon
                  const isActive = tab.key === 'industry'
                  return (
                    <Button
                      key={tab.key}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {((checkPermission('MOD014', 'create') && getUserType() === 'P1') ||
            ...
            <div className="flex items-center space-x-3">
              <Button onClick={() => router.push('/settings/jobType/create')}>
                      ...
                      {loading ? (
                        ...
                        currentIndustries.map(industry => (
                          <TableRow key={industry._id}>
                            ...
                            <TableCell>
                              {industry.parent_code || 'JT001'}
                            </TableCell>
                            <TableCell
                              className="max-w-[200px] truncate"
                              title={industry.description || 'No description'}
                            >
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem
                                    ...
                                    onClick={() =>
                                      router.push(
                                        `/settings/jobType/${industry._id}/view`
                                      )
                                    }
                                  >
